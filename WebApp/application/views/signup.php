<section class="container">
	<form id="signup-form" class="thin-form center-block content-block">
		...
		<hr>
			...
			<input type="email" id="email" name="user[email]" placeholder="Електронна Адреса" class="form-control input-lg" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="">
			<input type="password" id="password" name="user[password]" placeholder="Пароль" class="form-control input-lg" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="">
			<?php if (!$params["edit"]) { ?>
